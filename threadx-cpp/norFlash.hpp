...
template <typename T>
concept NorFlashDriver = requires(T t,
                                  ThreadX::Ulong *const flashAddress,
                                  const std::span<ThreadX::Ulong> destination,
                                  const std::span<const ThreadX::Ulong> source,
                                  const ThreadX::Ulong block,
                                  const ThreadX::Ulong blockCount,
                                  const ThreadX::Uint errorCode) {
    { t.initialise() } -> std::same_as<Error>;
    { t.read(flashAddress, destination) } -> std::same_as<Error>;
    // LevelX relies on the driver to verify that the write sector was successful. This is typically done by reading
    // back the programmed value to ensure it matches the requested value to be written.
...
struct NorSectorMetadata
{
    ...
    ThreadX::Ulong obsoleteFlag
        : 1; // Obsolete flag. When clear, this mapping is either obsolete or is in the process of becoming obsolete.
...
class NorFlash : ThreadX::Native::LX_NOR_FLASH, NorFlashBase
{
  ...
  public:
    ...
    static constexpr auto unusedMetadataWordsPerBlock{LevelX::norSectorSizeInWord -
                                                      (3 + freeBitmapWords + usableSectorsPerBlock)};
  ...
  private:
    struct DriverCallback
    {
        ...
        static auto read(ThreadX::Native::LX_NOR_FLASH *norFlashPtr,
                         ThreadX::Ulong *flashAddress,
                         ThreadX::Ulong *destination,
                         ThreadX::Ulong words) -> ThreadX::Uint;
        static auto write(ThreadX::Native::LX_NOR_FLASH *norFlashPtr,
                          ThreadX::Ulong *flashAddress,
                          ThreadX::Ulong *source,
                          ThreadX::Ulong words) -> ThreadX::Uint;
        static auto eraseBlock(ThreadX::Native::LX_NOR_FLASH *norFlashPtr,
                               ThreadX::Ulong block,
...
template <ThreadX::Uint BlockSectors, NorFlashDriver Driver, ThreadX::Uint CacheSectors>
NorFlash<BlockSectors, Driver, CacheSectors>::NorFlash(Driver &driver,
                                                       const ThreadX::Ulong storageSize,
                                                       const ThreadX::Ulong baseAddress)
    : ThreadX::Native::LX_NOR_FLASH{},
      m_driver{driver},
...
auto NorFlash<BlockSectors, Driver, CacheSectors>::open() -> Error
{
    ...
    {
        return Error{
            lx_nor_flash_extended_cache_enable(this, m_extendedCacheMemory.data(), m_extendedCacheMemory.size())};
    }
...
template <ThreadX::Uint BlockSectors, NorFlashDriver Driver, ThreadX::Uint CacheSectors>
auto NorFlash<BlockSectors, Driver, CacheSectors>::readSector(const ThreadX::Ulong logicalSector,
                                                              std::span<ThreadX::Ulong, norSectorSizeInWord> sectorData)
    -> Error
{
...
template <ThreadX::Uint BlockSectors, NorFlashDriver Driver, ThreadX::Uint CacheSectors>
auto NorFlash<BlockSectors, Driver, CacheSectors>::DriverCallback::initialise(
    ThreadX::Native::LX_NOR_FLASH *norFlashPtr) -> ThreadX::Uint
{
...
template <ThreadX::Uint BlockSectors, NorFlashDriver Driver, ThreadX::Uint CacheSectors>
auto NorFlash<BlockSectors, Driver, CacheSectors>::DriverCallback::read(ThreadX::Native::LX_NOR_FLASH *norFlashPtr,
                                                                        ThreadX::Ulong *flashAddress,
                                                                        ThreadX::Ulong *destination,
                                                                        ThreadX::Ulong words) -> ThreadX::Uint
{
...
template <ThreadX::Uint BlockSectors, NorFlashDriver Driver, ThreadX::Uint CacheSectors>
auto NorFlash<BlockSectors, Driver, CacheSectors>::DriverCallback::write(ThreadX::Native::LX_NOR_FLASH *norFlashPtr,
                                                                         ThreadX::Ulong *flashAddress,
                                                                         ThreadX::Ulong *source,
                                                                         ThreadX::Ulong words) -> ThreadX::Uint
{
...
template <ThreadX::Uint BlockSectors, NorFlashDriver Driver, ThreadX::Uint CacheSectors>
auto NorFlash<BlockSectors, Driver, CacheSectors>::DriverCallback::eraseBlock(
    ThreadX::Native::LX_NOR_FLASH *norFlashPtr, ThreadX::Ulong block, ThreadX::Ulong blockCount) -> ThreadX::Uint
{
    auto &norFlash{static_cast<NorFlash &>(*norFlashPtr)};
...
template <ThreadX::Uint BlockSectors, NorFlashDriver Driver, ThreadX::Uint CacheSectors>
auto NorFlash<BlockSectors, Driver, CacheSectors>::DriverCallback::verifyErasedBlock(
    ThreadX::Native::LX_NOR_FLASH *norFlashPtr, ThreadX::Ulong block) -> ThreadX::Uint
{
    auto &norFlash{static_cast<NorFlash &>(*norFlashPtr)};
...
template <ThreadX::Uint BlockSectors, NorFlashDriver Driver, ThreadX::Uint CacheSectors>
auto NorFlash<BlockSectors, Driver, CacheSectors>::DriverCallback::systemError(
    ThreadX::Native::LX_NOR_FLASH *norFlashPtr, ThreadX::Uint errorCode) -> ThreadX::Uint
{
    auto &norFlash{static_cast<NorFlash &>(*norFlashPtr)};
